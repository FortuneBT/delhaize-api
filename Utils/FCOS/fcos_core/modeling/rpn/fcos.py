...
from FCOS.fcos_core.layers import Scale
from FCOS.fcos_core.layers import DFConv2d
...
class FCOSModule(torch.nn.Module):
    ...
    def compute_locations_per_level(self, h, w, stride, device):
        shifts_x = torch.arange(0,
          (w * stride), step=stride, dtype=(torch.float32),
          device=device)
...
# okay decompiling ./fcos_core/modeling/rpn/fcos.pyc
